...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/permissions/privapp-permissions-dolby.xml:$(TARGET_COPY_OUT_PRODUCT)/etc/permissions/privapp-permissions-dolby.xml
...
# IPC router config
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/configs/ipc/sec_config:$(TARGET_COPY_OUT_VENDOR)/etc/sec_config
...
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/permissions/privapp-permissions-ims.xml:$(TARGET_COPY_OUT_SYSTEM_EXT)/etc/permissions/privapp-permissions-ims.xml \
    $(LOCAL_PATH)/permissions/privapp-permissions-camera2.xml:$(TARGET_COPY_OUT_SYSTEM_EXT)/etc/permissions/privapp-permissions-camera2.xml
